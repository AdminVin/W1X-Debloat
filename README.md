...
- If the file doesn't download after clicking, hold Control and press "J"
- Click on the three dots to the fight of the file and select "Keep" (for Edge) or select "Continue download" (for Chrome)
