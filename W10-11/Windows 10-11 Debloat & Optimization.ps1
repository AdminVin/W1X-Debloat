...
IF((Get-ItemProperty -Path "HKCU:\Control Panel\Mouse" -Name "MouseSensitivity").MouseSensitivity -eq 1) {
	...
	Write-Host "Mouse: Acceleration Fix - Set 'mouse curve' for current mouse sensitivity of $MouseSensitivity (Performance/Preference)" -ForegroundColor Yellow;Start-Sleep 5
}
...
Write-Host "Mouse: Acceleration Fix - Disabled Enhance Pointer Precision (Performance/Preference)" -ForegroundColor Green
