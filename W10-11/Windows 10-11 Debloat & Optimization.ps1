...
IF((Get-ItemProperty -Path "HKCU:\Control Panel\Mouse" -Name "MouseSensitivity").MouseSensitivity -eq 1) {
	...
	Write-Host "Mouse: Windows Sensitivity currently set at $MouseSensititivty; Adjusting 'mouse curve'(Performance/Preference)" -ForegroundColor Yellow;Start-Sleep 5
}
...
Write-Host "Mouse: Acceleration - Disabled Enhance Pointer Precision (Performance/Preference)" -ForegroundColor Green
