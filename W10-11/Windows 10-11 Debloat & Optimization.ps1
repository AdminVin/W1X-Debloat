...
IF((Get-ItemProperty -Path "HKCU:\Control Panel\Mouse" -Name "MouseSensitivity").MouseSensitivity -eq 1) {
	...
	Write-Host "Mouse: Acceleration Fix - Set 'mouse curve' for current mouse sensitivity of $MouseSensitivity (Performance/Preference)" -ForegroundColor Green;Start-Sleep 2
}
