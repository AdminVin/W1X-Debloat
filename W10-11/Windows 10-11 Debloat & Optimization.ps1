...
if ($result -eq [System.Windows.Forms.DialogResult]::Yes) {
	Write-Host "3.2.2 Microsoft One Drive Removal [Skipped]" -ForegroundColor Yellow
		...
		Write-Host "3.2.2 Microsoft One Drive Removed" -ForegroundColor Green
...
$result = [System.Windows.Forms.MessageBox]::Show("Would you like your mouse sensitivity set to '7', to slow down mouse movement for more accurate control?`n`n`nClicking 'Yes' will set your mouse speed to '7' sensitivity.`n`nClicking 'No' will leave it at the current setting.", "Confirm", [System.Windows.Forms.MessageBoxButtons]::YesNo)
if ($result -eq [System.Windows.Forms.DialogResult]::Yes) {
	# Smooth Mouse Curve
	<# Mouse Speed 7 (Windows) #>
	Set-ItemProperty -LiteralPath 'HKCU:\Control Panel\Mouse' -Name 'MouseSensitivity' -Value '7' | Out-Null
	...
	# Smooth Mouse Curve
	<# Mouse Speed 10 (Windows) [Default] #>
